...
p1=float(p1)
gas1.TP = T1, p1
gas1.set_equivalence_ratio(equiv_ratio1, 'CH4:3.0, H2:3.0', 'O2:1.0, N2:3.76')
...
p2=float(p2)
gas2.TP = T2, p2
gas2.set_equivalence_ratio(equiv_ratio2, 'CH4:3.0, H2:3.0', 'O2:1.0')
...
while combustor1.T > 500 or combustor2.T > 500:
    ...
    if combustor2.T > T2:
        ...
        if (combustor1.T < T1 and combustor2.T < T2): break
